...
const SubscribeSection = () => {
  return (
    <section className="w-full [background:linear-gradient(to_bottom,#fff_0%,#fff_20%,#2563eb_20%,#2563eb_80%,#fff_80%,#fff_100%)] py-6">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-6 md:px-12">
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-start mb-6 md:mb-0">
          <img src={teamImage} alt="Tim Nusea" className="rounded-lg h-[280px] md:h-[320px] max-h-[250px] object-cover"/>
        </div>
