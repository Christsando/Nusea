    ...
    <section className="w-full py-0 pt-20 bg-white" id="about">
      <div className="container mx-auto grid md:grid-cols-2 gap-10 items-center px-6 md:px-0">
        ...
        <div className="relative flex justify-end items-end">
          ...
          <a href="/login" className="absolute bottom-5 lg:bottom-10  left-1/2 transform -translate-x-1/2 px-6 py-3 bg-orange-500 text-white lg:text-2xl md:text-xl font-bold rounded-full shadow-lg shadow-white/50 hover:bg-orange-600 cursor-pointer">
            Belanja Sekarang
          </a>
        </div>
      </div>
