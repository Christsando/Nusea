    ...
    <div className="flex flex-col w-full">
      ...
      <div className="w-full relative">
        ...
        <div className="absolute lg:bottom-1/4 lg:left-20 bottom-1 left-1 flex flex-col justify-center items-center gap-3">
          ...
          <a href="mailto:contact@nusea.com" className="py-3 px-10 bg-[#FE6647] lg:text-2xl text-sm text-white font-bold rounded-full hover:bg-[#ff876f] cursor-pointer">Setor Tangkapan</a>
        </div>
      </div>
    </div>
  );
