...
export default function Hero() {
  return (
    ...
    >
      <div className="bg-black bg-opacity-40 w-full h-full flex flex-col items-center justify-end">
        <h1 className="text-4xl md:text-6xl font-extrabold text-white drop-shadow-lg">
          SEAFOOD SEGAR <br /><br /> DARI INDONESIA MENUJU DUNIA
        </h1>
      </div>
      <div className="px-60 bg-black bg-opacity-40 w-full h-full flex flex-col items-start justify-center">
